...
<div class="form-modal">
    ...
    <div id="signup-form">
        <form>
            ...
            <hr/>
            <button type="button" class="btn -box-sd-effect"> <i class="fas fa-google fa-lg" aria-hidden="true"></i> sign up with google</button>
            <button type="button" class="btn -box-sd-effect"> <i class="fas fa-linkedin fa-lg" aria-hidden="true"></i> sign up with linkedin</button>
            <button type="button" class="btn -box-sd-effect"> <i class="fas fa-windows fa-lg" aria-hidden="true"></i> sign up with microsoft</button>
        </form>
    </div>
